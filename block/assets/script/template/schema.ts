 ...
 * 僵尸刷新后行为
 */
export enum ECarMonsterMoveType {
    /**
     * 路面僵尸范围内站立
     */
    Stand = 1,
...
export class TempEnemyPrototype {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.resBundle === undefined) { throw new Error() }
        this.resBundle = _json_.resBundle
        if (_json_.resPath === undefined) { throw new Error() }
...
export class TempStage {
    ...
    constructor(_json_: any) {
        ...
        { this.mid = []; for(let _ele0 of _json_.mid) { let _e0; _e0 = new temp.IdNum(_ele0); this.mid.push(_e0);}}
        ...
        { this.range = []; for(let _ele0 of _json_.range) { let _e0; _e0 = _ele0; this.range.push(_e0);}}
        if (_json_.Transverse === undefined) { throw new Error() }
        this.Transverse = _json_.Transverse
        if (_json_.Direction === undefined) { throw new Error() }
     ...
     * 怪物刷新后行为
     */
    readonly action: temp.ECarMonsterMoveType
    /**
     * 怪物刷新范围（横向/纵向）
     */
    ...
    resolve(tables:Tables)
    {
        ...
        for (let _e of this.mid) { _e?.resolve(tables); }
