System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, Prefab, Size, GridItem, GridBgItem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, GrudManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GrudManager", GrudManager = (_dec = ccclass('GrudManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Node), _dec(_class = (_class2 = class GrudManager extends Component {
        constructor() {
          super(...arguments);
        ...
        initGridList() {
          ...
          for (var i = 0; i < this._gridData.length; i++) {
            var element = this._gridData[i];

            for (var j = 0; j < element.length; j++) {
              var item = element[j];
              var gridItem = instantiate(this.gridPreab);
        ...
        initAllGridList() {
          for (var i = 0; i < this._maxGrid.length; i++) {
            var element = this._maxGrid[i];

            for (var j = 0; j < element.length; j++) {
              var item = element[j];
              var gridBgItem = instantiate(this.gridBgPreab);
...
//# sourceMappingURL=85c8e1f12a24cdf557ae32d53f1aab885cd263df.js.map