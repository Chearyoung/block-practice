System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2c0a8ni5C1M+oGk3xONC87q", "GridManager", undefined);
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec(_class = (_class2 = class GridManager extends Component {
        ...
        cherGridStatus(posArr, weaponItem) {
          var wid = weaponItem.weaponCfg.tempId;
          var gridIndexArr = [];
          var items = this.gridList.children;
            ...
            if (sanmeCount == gridIndexArr.length) {
              ...
              if ((_crd && WeaponData === void 0 ? (_reportPossibleCrUseOfWeaponData({
                ...
                game.emit((_crd && EventConstant === void 0 ? (_reportPossibleCrUseOfEventConstant({
                  error: Error()
                }), EventConstant) : EventConstant).WEAPON_ICON_STATUS, _weaponKey, true);
              }
            }
          } //设置抖动
          ...
          for (var _index = 0; _index < placeWeaponKeyArr.length; _index++) {
            ...
            game.emit((_crd && EventConstant === void 0 ? (_reportPossibleCrUseOfEventConstant({
              error: Error()
            }), EventConstant) : EventConstant).WEAPON_SHAKE, _element3);
          }
        }
        /* 武器移动 */
...
//# sourceMappingURL=4b49d5e408460c7a8deaf38f8633861b4c3ea835.js.map