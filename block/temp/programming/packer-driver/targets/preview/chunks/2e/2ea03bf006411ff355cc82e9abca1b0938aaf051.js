      ...
      _export("TempHeroBreak", TempHeroBreak = class TempHeroBreak {
        constructor(_json_) {
...

          {
            ...
            for (var _ele4 of _json_.reward) {
              var _e5 = void 0;

              _e5 = new temp.IdNum(_ele4);
              this.reward.push(_e5);
            }
          }
        }
        ...
        resolve(tables) {
          ...
          for (var _e6 of this.attribute) {
            _e6 == null || _e6.resolve(tables);
          }

          for (var _e7 of this.reward) {
            _e7 == null || _e7.resolve(tables);
          }
        }
      ...
      _export("TempHeroStar", TempHeroStar = class TempHeroStar {
        constructor(_json_) {
...

          {
            ...
            for (var _ele5 of _json_.attribute) {
              var _e8 = void 0;

              _e8 = new temp.AttrVal(_ele5);
              this.attribute.push(_e8);
            }
          }
        }
      ...
      _export("TempSkill", TempSkill = class TempSkill {
        constructor(_json_) {
...

          {
            ...
            for (var _ele6 of _json_.triggerConditionPara) {
              var _e10 = void 0;

              _e10 = _ele6;
              this.triggerConditionPara.push(_e10);
            }
          }
...

          {
            ...
            for (var _ele7 of _json_.skillEffects) {
              var _e11 = void 0;

              _e11 = _ele7;
              this.skillEffects.push(_e11);
            }
          }
      ...
      _export("TempSkillEffect", TempSkillEffect = class TempSkillEffect {
        constructor(_json_) {
...

          {
            ...
            for (var _ele8 of _json_.targetRangePara) {
              var _e12 = void 0;

              _e12 = _ele8;
              this.targetRangePara.push(_e12);
            }
          }
      ...
      _export("TempEnemyPrototype", TempEnemyPrototype = class TempEnemyPrototype {
        constructor(_json_) {
...

          {
            ...
            for (var _ele9 of _json_.passiveSkills) {
              var _e13 = void 0;

              _e13 = _ele9;
              this.passiveSkills.push(_e13);
            }
          }
      ...
      _export("TempCar", TempCar = class TempCar {
        constructor(_json_) {
...

          {
            ...
            for (var _ele10 of _json_.defendPosArr) {
              var _e14 = void 0;

              _e14 = new temp.Vec2(_ele10);
              this.defendPosArr.push(_e14);
            }
          }
        }
        ...
        resolve(tables) {
          ...
          for (var _e15 of this.defendPosArr) {
      ...
      _export("TempBlockGrid", TempBlockGrid = class TempBlockGrid {
        constructor(_json_) {
...

          {
            ...
            for (var _ele13 of _json_.maxGridLen) {
              var _e18 = void 0;

              _e18 = _ele13;
              this.maxGridLen.push(_e18);
            }
          }
...

          {
            ...
            for (var _ele14 of _json_.privateGridWidth) {
              var _e19 = void 0;

              _e19 = _ele14;
              this.privateGridWidth.push(_e19);
            }
          }
...

          {
            ...
            for (var _ele15 of _json_.privateGrid) {
              var _e20 = void 0;

              {
                _e20 = [];

                for (var _ele1 of _ele15) {
                  var _e1 = void 0;
...

          {
            ...
            for (var _ele16 of _json_.maxGrid) {
              var _e21 = void 0;

              {
                _e21 = [];

                for (var _ele17 of _ele16) {
                  var _e22 = void 0;
      ...
      _export("TempBlockItem", TempBlockItem = class TempBlockItem {
        constructor(_json_) {
...

          {
            ...
            for (var _ele18 of _json_.shapeTypePara) {
              var _e23 = void 0;

              {
                _e23 = [];

                for (var _ele1 of _ele18) {
                  var _e1 = void 0;
      ...
      _export("TempPublicRogueSkill", TempPublicRogueSkill = class TempPublicRogueSkill {
        constructor(_json_) {
...

          {
            ...
            for (var _ele19 of _json_.repelId) {
              var _e24 = void 0;

              _e24 = _ele19;
              this.repelId.push(_e24);
            }
          }
...

          {
            ...
            for (var _ele20 of _json_.targetRangePara) {
              var _e25 = void 0;

              _e25 = _ele20;
              this.targetRangePara.push(_e25);
            }
          }
        }
      ...
      _export("TempCreature", TempCreature = class TempCreature {
        constructor(_json_) {
...

          {
            ...
            for (var _ele21 of _json_.passiveSkills) {
              var _e26 = void 0;

              _e26 = _ele21;
              this.passiveSkills.push(_e26);
            }
          }
...
//# sourceMappingURL=2ea03bf006411ff355cc82e9abca1b0938aaf051.js.map