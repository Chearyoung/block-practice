System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dba6bgRY0NLgKRChmMMkqwW", "GridMapManager", undefined);
      ...
      _export("GridMapManager", GridMapManager = (_dec = ccclass('GridMapManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class GridMapManager extends Component {
        ...
        initGridRes() {
          ...
          var offerY = Number(rowColArr[0]) > 5 ? 100 : 200;
        ...
        getConnectStatus(gridObj) {
          ...
          var colLen = Number(row_col[1]); // 边界检查
        ...
        checkAddAreaGridData() {
          var isConnected = true; // 默认连接

          var item = null;

          for (var [key, gridBgObj] of this._addPlaceAreaData) {
            if (key !== this._mainAreaKey) {
              item = gridBgObj.item;
              var data = gridBgObj.data;
              var isConnect = false; // 定义四个方向的偏移量
              ...
              for (var direction of directions) {
                for (var gridObj of data) {
                  var checkObj = new (_crd && GridObj === void 0 ? (_reportPossibleCrUseOfGridObj({
                    error: Error()
                  }), GridObj) : GridObj)();
...
//# sourceMappingURL=3ea5704d0386b69426d7b28b5b67e8eef50d7315.js.map